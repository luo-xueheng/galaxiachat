...
import { DownOutlined, UserAddOutlined, UserDeleteOutlined, ArrowLeftOutlined } from '@ant-design/icons';
...
const ChatGroupManagement = () => {
    ...
    return (
        <Layout style={{ minHeight: '100vh', background: '#f5f5f5' }}>
            <Header style={{ background: '#fff', padding: '16px', boxShadow: '0 2px 8px #f0f1f2', display: 'flex', alignItems: 'center' }}>
                {/* 返回按钮 */}
                <Button
                    type="text"
                ...
                <div style={{ flex: 1, textAlign: 'center' }}>
                    <Title level={3} style={{ margin: 0 }}>群聊管理</Title>
                </div>
            </Header>

            <Content style={{ padding: '24px' }}>
                <Card bordered={false}>
                    <Typography.Title level={4}>群聊名称</Typography.Title>
                    <Typography.Paragraph>{groupname}</Typography.Paragraph>
                    <Divider />

                    <Typography.Title level={4}>群成员</Typography.Title>
                    <div style={{ display: 'flex', gap: 16, overflowX: 'auto', paddingBottom: 8 }}>
                        {groupMembers.map((member, index) => (
                            ...
                            >
                                ...
                                <div style={{ marginTop: 8 }}>{member.username}</div>
                        ...
                        {/* 添加成员：直接展示图标或按钮，设置宽度保持对齐 */}
                        <div style={{ minWidth: 160, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                            <AddMemberDropdown />
                        </div>
                    ...
                    <Typography.Title level={4}>历史群公告</Typography.Title>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                        {historyAnnounceList.map(item => (
                ...
                {(currentUserRole === "creator" || currentUserRole === "admin") && (
                    <Card bordered={false} style={{ marginTop: 24 }}>
                        <Typography.Title level={4}>发布群公告</Typography.Title>
                        <Button type="primary" onClick={showModal}>发送群公告</Button>
                        <Modal
                            title="公告编辑"
                            open={modalOpen}
                        ...
                        >
                            ...
                            />
                            <Button type="primary" onClick={saveAnnounce} style={{ marginTop: 12 }}>
                                保存草稿
                            </Button>
                        </Modal>
                    </Card>
                ...
                {currentUserRole === "creator" && (
                    <Card bordered={false} style={{ marginTop: 24 }}>
                        ...
                        <Space wrap>
                            <Button onClick={showModal1}>添加群管理员</Button>
                            <Button onClick={showModal2}>群主转让</Button>
                        </Space>
            ...
            <Footer style={{ textAlign: 'center', background: '#fff' }}>
                <Button danger type="primary" onClick={handleLeaveGroup}>
                    退出群聊
                </Button>
            </Footer>
        </Layout>
